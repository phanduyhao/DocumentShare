                                                        ...
                                                        <div class="action-click">
                                                            <div class="action-read-download">
                                                                ...
                                                                <div class="action-read-download-btn">
                                                                    <a data-id="{{$document->id}}" data-score-doc="{{$document->score}}" @auth data-score-user="{{ Auth::user()->score }}" data-user-id="{{ Auth::id() }}" @endauth href="/temp/filesOrigin/{{$document->file}}.{{$document->type}}" download class="download-file">Tải xuống</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
